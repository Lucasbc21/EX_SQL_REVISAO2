...
--e o valor total ganho por viagem, sabendo que para distâncias inferiores a 1000 km, 
--o valor é R$10,00 por km e para viagens superiores a 1000 km,
--o valor é R$15,00 por km.
SELECT 
       e.nome,
       c.marca,
	   c.modelo,
